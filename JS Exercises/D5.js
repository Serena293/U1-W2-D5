...
console.log("Esercizio 2: ", ordineAlfabetico);

/* ESERCIZIO 3
    Scrivi del codice per stampare nuovamente in console gli elementi dell'array "pets", questa volta in ordine invertito.
*/
const ordineInvertito = ordineAlfabetico.reverse();
console.log("Esercizio 3", ordineInvertito);
/* ESERCIZIO 4
    Scrivi del codice per spostare il primo elemento dall'array "pets" in ultima posizione.
*/

const primoElemento = pets.shift();
console.log("debug", primoElemento);
const elementiInvertiti = pets.push(primoElemento);
...
for (let i = 0; i < cars.length; i++) {
  const ultimoTrim = cars[i].trims.pop();
}
console.log("Esercizio 6 (rimuovere ultimo trim): ", cars);
/* ESERCIZIO 7
